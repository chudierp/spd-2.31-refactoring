...
class School:
    ...
    def process_graduation(self):
        ...
        passed_students = acceptable_gpa(self, students)
    ...
    def congrats_emails(self, passed_students):
        # Send congrat emails to them.
        for s in passed_students:
            s.send_congrat_email()
    
    def top_10(self, passed_students):
    ...
    def acceptable_gpa(self, students):
        '''Calculate acceptable GPA's '''
